                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <span className="text-xs font-bold uppercase tracking-widest text-red-700">{project.theme}</span>
                        </div>
                      ...
                      {/* CTA */}
                      <Link href="/forms" className="inline-flex items-center gap-2 text-red-700 font-bold hover:gap-3 transition-all duration-200 text-sm group/link">
                        Learn More
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {[
                  ...
                  <div key={idx} className="flex gap-4">
                    <item.icon className="text-red-700 flex-shrink-0" size={28} />
                    <div>
