                ...
                <Card className="border border-border border-border hover:border-border transition-all duration-300">
                  <CardContent className="p-10">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-lg bg-white flex items-center justify-center text-cyan-600 flex-shrink-0">
                        <Mail className="w-6 h-6" />
                      </div>
                      <div>
                        <h3 className="font-bold text-lg text-foreground mb-2">Email</h3>
                        <a href="mailto:NU-launchlabs@northeastern.edu" className="text-cyan-600 hover:text-cyan-600 transition-colors font-medium break-all">
                ...
                <Card className="border border-border border-border hover:border-border transition-all duration-300">
                  <CardContent className="p-10">
                    ...
                    <div className="space-y-3">
                      <a href="https://www.linkedin.com/company/nulaunchlabs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-foreground/70 hover:text-cyan-600 transition-colors font-medium">
                        <Linkedin size={20} className="text-cyan-600" />
                        LinkedIn
                      </a>
                      <a href="https://instagram.com/nulaunchlabs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-foreground/70 hover:text-cyan-600 transition-colors font-medium">
                        <Instagram size={20} className="text-cyan-600" />
                        Instagram
                      </a>
                      <a href="https://discord.gg/EVSEDPDv" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-foreground/70 hover:text-cyan-600 transition-colors font-medium">
              ...
              <div className="space-y-6">
                ...
                <Card className="border border-border border-border hover:border-border transition-all duration-300">
                  <CardContent className="p-10">
                    ...
                    <Link href="/forms">
                      <Button className="w-full bg-cyan-600 hover:bg-cyan-600 text-white font-bold h-10 rounded-lg inline-flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg">
                        View Forms
                        <ArrowRight size={16} />
                      </Button>
                    </Link>
