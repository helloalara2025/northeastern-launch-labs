        ...
        <section className="bg-white border-t border-border py-16 md:py-20">
          <div className="container">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <a href="#current-partners" className="text-foreground/70 hover:text-red-700 transition-colors font-medium text-sm">Current Partners</a>
              <a href="#what-we-do" className="text-foreground/70 hover:text-red-700 transition-colors font-medium text-sm">What We Do</a>
              <a href="#key-experiences" className="text-foreground/70 hover:text-red-700 transition-colors font-medium text-sm">Key Experiences</a>
              <a href="#who-should-apply" className="text-foreground/70 hover:text-red-700 transition-colors font-medium text-sm">Who Should Apply</a>
            </div>
          </div>
        </section>
                ...
                <div key={partner.id} className={`project-card ${partner.isPlaceholder ? 'placeholder-card' : 'glass-card'}  p-8 border`}>
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <span className="text-xs font-semibold uppercase tracking-widest text-red-700">{partner.theme}</span>
                    </div>
                  </div>
                  <div className="mb-6">
                  ...
                  {!partner.isPlaceholder && (
                    <Link href="/forms" className="inline-flex items-center gap-2 text-red-700 font-semibold hover:gap-3 transition-all duration-200 text-sm">
                      Learn More
                      <ArrowRight size={16} />
                    </Link>
                  )}
              ...
              {teams.map((team) => (
                <Card key={team.id} className="project-card border border-border hover:border-border transition-all duration-300 bg-white ">
                  <CardContent className="p-12">
                    ...
                    <Link href="https://forms.office.com/Pages/ResponsePage.aspx?id=gcLuqKOqrk2sm5o5i5IV58t6J076SB1BnXzyi1fYH2VUNVU1NFZPWkNMSlU3NFlQRlpGNVhWR1lQVS4u" target="_blank" className="inline-flex items-center gap-2 text-red-700 font-semibold hover:gap-3 transition-all duration-200 text-sm">
                      Apply Now
                      <ArrowRight size={16} />
                    </Link>
                  </CardContent>
          ...
          <div className="container">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <CheckCircle className="w-6 h-6 text-red-700 flex-shrink-0 mt-0.5" />
          ...
          <div className="grid md:grid-cols-4 gap-16 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><Link href="/about" className="text-foreground/70 hover:text-red-700 transition-colors">About</Link></li>
