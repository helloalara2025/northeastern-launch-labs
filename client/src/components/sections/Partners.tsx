    ...
    <section id="partners" className="py-24 bg-white border-t border-foreground/5">
      <div className="container">
        <div className="max-w-3xl mx-auto mb-16">
          <h2 className="font-sans font-bold text-5xl md:text-6xl text-foreground mb-4 leading-tight">
        ...
        <div className="bg-foreground/5 rounded-xl p-12 text-center">
          <p className="text-foreground/60 font-regular">Partner profiles coming soon</p>
        </div>
      </div>
    </section>
  );
