export default function Teams() {
  return (
    <section id="teams" className="py-24 bg-primary border-t border-foreground/8">
      <div className="container">
        <h2 className="font-sans font-semibold text-4xl lg:text-5xl text-foreground mb-16 leading-tight">
          Two Ways to<br />
          <span className="text-red">Make an Impact</span>
        </h2>

        <div className="grid md:grid-cols-2 gap-8">
          {/* Launch Teams */}
          <div className="group bg-secondary border border-foreground/5 p-8 hover:border-red/30 hover:shadow-lg transition-all duration-300">
            <div className="mb-6">
              <div className="w-12 h-12 bg-red flex items-center justify-center mb-4">
          ...
          {/* Innovation Teams */}
          <div className="group bg-secondary border border-foreground/5 p-8 hover:border-yellow/30 hover:shadow-lg transition-all duration-300">
            <div className="mb-6">
