...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center py-32 bg-white overflow-hidden">
      {/* Subtle background accent */}
      <div className="absolute top-32 right-0 w-96 h-96 bg-primary/8 rounded-full blur-3xl -z-10"></div>

      <div className="container relative z-10">
        <div className="max-w-2xl space-y-8">
          <h1 className="font-sans font-bold text-7xl lg:text-8xl text-foreground leading-tight tracking-tight">
            From Idea to Impact
          </h1>
          
          <p className="text-xl text-foreground/60 leading-relaxed font-regular max-w-lg">
