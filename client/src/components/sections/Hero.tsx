...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-32 pb-20 bg-white overflow-hidden">
      {/* Subtle background decoration - yellow accent */}
      ...
      <div className="container relative z-10 grid lg:grid-cols-2 gap-20 items-center">
        ...
        {/* Enhanced Notion/Figma-inspired Visual with yellow accents */}
        <div className="hidden lg:flex items-center justify-center">
          <div className="relative w-full h-full min-h-96">
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Sophisticated block hierarchy with yellow accents */}
              <g className="text-primary">
                {/* Primary block - center */}
                <rect x="60" y="80" width="280" height="140" rx="12" fill="currentColor" fillOpacity="0.12" stroke="currentColor" strokeWidth="2" strokeOpacity="0.4" />
                <circle cx="95" cy="120" r="5" fill="currentColor" fillOpacity="0.8" />
                <line x1="110" y1="120" x2="200" y2="120" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.3" />
                <line x1="110" y1="140" x2="280" y2="140" stroke="currentColor" strokeWidth="1" strokeOpacity="0.2" />
                <circle cx="95" cy="180" r="5" fill="currentColor" fillOpacity="0.6" />
                <line x1="110" y1="180" x2="220" y2="180" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.25" />
                
                {/* Secondary blocks - top */}
                <rect x="40" y="20" width="110" height="50" rx="8" fill="currentColor" fillOpacity="0.08" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.25" />
                <rect x="250" y="20" width="110" height="50" rx="8" fill="currentColor" fillOpacity="0.08" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.25" />
                
                {/* Secondary blocks - bottom */}
                <rect x="40" y="250" width="110" height="50" rx="8" fill="currentColor" fillOpacity="0.08" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.25" />
                <rect x="250" y="250" width="110" height="50" rx="8" fill="currentColor" fillOpacity="0.08" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.25" />
              </g>
              
              {/* Elegant connecting lines */}
              <g stroke="currentColor" strokeWidth="1.2" strokeOpacity="0.15" fill="none" className="text-primary">
