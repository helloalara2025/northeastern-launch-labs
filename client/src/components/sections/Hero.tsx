          ...
          <div className="relative h-96 hidden lg:block">
            <svg viewBox="0 0 400 400" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
              ...
              <g>
                ...
                <circle cx="35" cy="55" r="3" fill="#0891b2"/>
                ...
                <rect x="30" y="110" width="50" height="8" rx="2" fill="#0891b2" opacity="0.2"/>
              </g>
              ...
              <g>
                ...
                <circle cx="255" cy="95" r="3" fill="#0891b2"/>
                ...
                <rect x="250" y="150" width="50" height="8" rx="2" fill="#0891b2" opacity="0.2"/>
              </g>
              ...
              <g>
                ...
                <circle cx="145" cy="235" r="3" fill="#0891b2"/>
                ...
                <rect x="140" y="290" width="50" height="8" rx="2" fill="#0891b2" opacity="0.2"/>
              </g>

              {/* Connecting lines */}
              <line x1="160" y1="160" x2="240" y2="140" stroke="#0891b2" strokeWidth="1.5" opacity="0.3" strokeDasharray="5,5"/>
              <line x1="200" y1="220" x2="200" y2="160" stroke="#0891b2" strokeWidth="1.5" opacity="0.3" strokeDasharray="5,5"/>
            </svg>
          </div>
        </div>
      </div>
