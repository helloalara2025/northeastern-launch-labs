...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      {/* Contact Box */}
      {isOpen && (
        <div className="absolute bottom-20 right-0 bg-white rounded-lg shadow-2xl border border-gray-100 p-6 w-72 mb-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="space-y-4">
            ...
            <a
              ...
              className="flex items-center gap-3 p-3 rounded-lg bg-white hover:bg-white transition-colors group"
            >
      ...
      <button
        ...
        className="bg-red-900 hover:bg-red-900 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center h-14 w-14"
      >
        {isOpen ? (
          <X size={24} />
        ) : (
