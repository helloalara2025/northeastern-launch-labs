...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      {/* Contact Box */}
      {isOpen && (
        <div className="absolute bottom-20 right-0 bg-white  shadow-2xl border border-gray-100 p-6 w-72 mb-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="space-y-4">
            ...
            <a
              ...
              className="flex items-center gap-3 p-3  bg-white hover:bg-white transition-colors group"
            >
              <Mail size={20} className="text-red-900 flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-xs text-gray-100">Email</p>
            ...
            <a
              ...
              className="flex items-center gap-3 p-3  bg-blue-50 hover:bg-blue-100 transition-colors group"
            >
              <Linkedin size={20} className="text-blue-600 flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-xs text-gray-100">LinkedIn</p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3  bg-pink-50 hover:bg-pink-100 transition-colors group"
            >
              <Instagram size={20} className="text-pink-600 flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-xs text-gray-100">Instagram</p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3  bg-indigo-50 hover:bg-indigo-100 transition-colors group"
            >
              <MessageCircle size={20} className="text-indigo-600 flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-xs text-gray-100">Discord</p>
      ...
      <button
        ...
        className="bg-red-900 hover:bg-red-900 text-white  p-4 shadow-lg hover:shadow-lg transition-all duration-200 flex items-center justify-center h-14 w-14"
      >
        {isOpen ? (
          <X size={24} />
        ) : (
